...
static IPAddress ip(192, 168, 0, 182); // Our address
static IPAddress gateway(192, 168, 0, 1);
static IPAddress netmask(255, 255, 255, 0);

static const char* MY_SSID = "xxx";
static const char* MY_PASSPHRASE = "xxx";
...
// for ESP32-S3 Zero
static constexpr const int tck_gpio = 1;
static constexpr const int tdo_gpio = 2;
static constexpr const int tdi_gpio = 3;
static constexpr const int tms_gpio = 4;

// Transition delay coefficients
static const unsigned int jtag_delay = 10;  // NOTE!
//timing tested on ESP32 S3 Zero
